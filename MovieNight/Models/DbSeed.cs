    ...
    public static class DbSeed
    {
        ...
        public async static Task SeedMovies()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                // http://www.omdbapi.com/?i=tt3896198&apikey=9f7b59af
                client.BaseAddress = new Uri("http://www.omdbapi.com/");

                foreach (var imdbId in ImdbMovieIds())
                {
                    var result = await client.GetAsync("?apikey=9f7b59af&i=" + imdbId);

                    if (result.IsSuccessStatusCode)
                    {
                        // install-package Microsoft.AspNet.WebApi.Client
                        // Apileri ulaşmaya sağlayan kütüphane
